    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-3">
          <img src={logo} alt="Emblema da Marinha do Brasil" width={1024} height={1024} className="mx-auto h-20 w-20 object-contain" />
          <h1 className="font-display text-2xl font-bold uppercase tracking-widest flex items-center justify-center gap-2">
            <Scale className="h-5 w-5" /> JMU
          </h1>
          <p className="text-sm text-muted-foreground">
            Acesso exclusivo com credenciais da Justiça Militar da União.
          </p>
        </div>
